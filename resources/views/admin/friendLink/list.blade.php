            ...
            <div class="mDiv">
                    ...
                    <el-dialog
                        ...
                        <div class="" style="text-align: center">
                            <dl class="rows">
                                ...
                                <dd class="opt">
                                    <input type="text" value="" class="web_name el-input__inner">
                                </dd>
                            </dl>
                            <dl class="rows">
                                <dt style="text-align: left;width: 150px;">
                                ...
                                <dd class="opt">
                                    <input type="text" value="" class="link_name el-input__inner">
                                </dd>
                            </dl>
                            <dl class="rows">
                                <dt style="text-align: left;width: 150px;">
                                ...
                                <dd class="opt">
                                    <input type="text" value="" class="web_note el-input__inner">
                                </dd>
                            </dl>
                            <dl class="rows">
                                ...
                                <dd class="opt">
                                    <el-radio v-model="link_state" label="1">已发布</el-radio>
                                    <el-radio v-model="link_state" label="0">未发布</el-radio>
                                </dd>
                            </dl>
                            <dl class="rows">
                                <dt style="text-align: left;width: 150px;">
                                ...
                                <dd class="opt">
                                    <input type="text" value="" class="link_sorting el-input__inner">
                                </dd>
                            </dl>
                            <dl class="rows">
                        ...
                        <span slot="footer" class="dialog-footer">
                            <el-button type="primary" @click="link_submit()">提交</el-button>
                          </span>
                    </el-dialog>
                </div>
                ...
                <div>
                    <el-dialog
                        ...
                        <span slot="footer" class="dialog-footer">
                            <el-button type="primary" @click="link_modify_submit">提交</el-button>
                          </span>
                    </el-dialog>
                </div>
            </div>
            ...
            methods: {
                ...
                link_submit() {
                    $.ajax({
                        ...
                        data: {
                            ...
                            link:  $('.link_name').val(),
                            sort:  $('.link_sorting').val(),
                            state: this.link_state
                        },
                        //返回数据格式为json
                        dataType: "json",
                        //请求成功完成后要执行的方法
                        ...
                        success: function (data) {
                            if (data.code != 200) {
                                alert(data.message)
                                    ...
                                    $('.web_note').val(data.data.note),
                                    $('.link_name').val(data.data.link),
                                    $('.link_sorting').val(data.data.sort),
                                    window.link_state = data.data.state
                ...
                link_modify_submit(){
                    $.ajax({
                        ...
                        type: "post",
                        //url接口地址
                        url: "/admin/friendLink/edit/"+link_modify_submit_id,
                        data: {
                            name: $('.web_name').val(),
                            note:  $('.web_note').val(),
                            picture: this.link_img,
